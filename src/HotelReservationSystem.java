...
public class HotelReservationSystem {
    ...
    private static final String username = "root"; // your username usually its root for all.
    private static final String password = "Password"; // your sql password .
    ...
    private static void viewReservations(Connection connection) throws SQLException {
        ...
        try (Statement statement = connection.createStatement();
            ...
            System.out.println("+----------------+-----------------+---------------+----------------------+-------------------------+");
            System.out.println("| Reservation ID | Guest           | Room No | Contact No  | Reservation Date        |");
            System.out.println("+----------------+-----------------+---------------+----------------------+-------------------------+");
